...
import PersoonlijkeGegevens from './PersoonlijkeGegevens.vue';
import Basisverzekering from './Basisverzekering.vue';
import Betaaltermijn from './Betaaltermijn.vue';
import EigenRisico from './EigenRisico.vue';
